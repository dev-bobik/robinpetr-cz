...
export const PRICING = [
  ...
  },
  {
    /* Obě webové položky musí začínat na „Web podniku" — lead-scanner
       ...
       VŠECHNY weby v žebříku. 8 900 Kč je základ (stránka s tím, co je
       popsané na /sluzby), každá funkce navíc (rezervace, galerie, další
       jazyk, napojení na věrnost…) se přičítá podle rozsahu. Důvod „od"
  ...
  },
  {
    ...
    oneTimeFrom: true,
    monthlyCzk: 690,
    text: "od 14 900 Kč podle přidaných funkcí + 690 Kč/měsíc, bez provizí",
  },
  {
    id: "eshop",
    skupina: "web",
